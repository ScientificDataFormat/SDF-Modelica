within SDF.Functions;
impure function makeDatasetDouble2D "Create a 2-dimensional dataset of type double"
...
protected
  String errorMessage;
algorithm
  errorMessage := SDF.Internal.Functions.makeDatasetDouble2D(
    fileName,
    datasetName,
    values,
    comment,
